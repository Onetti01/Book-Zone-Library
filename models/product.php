...
class Product
{
    ...
    public function getProductListSearchedByName()
    {
        try {
            $query = $this->pdo->prepare("SELECT * FROM productos WHERE nombre LIKE '%{$this->getNombre()}%';");
            $query->execute();
            return $query->fetchAll(PDO::FETCH_OBJ);
        } catch (Exception $e) {
            die($e->getMessage());
    ...
    public function getProductListSearchedByNameJson()
    {
        try {
            $query = $this->pdo->prepare("SELECT * FROM productos WHERE nombre LIKE '%{$this->getNombre()}%';");
            $query->execute();

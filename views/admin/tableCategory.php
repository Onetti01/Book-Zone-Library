<section class="tabla">
    <form class="admin-menu" action="index.php?c=Admin&a=postSearchCategory&t=Buscar%20categoria" method="POST">
        <a  href="index.php?c=Admin&a=addCategory&t=Añadir%20categoria">Añadir categorias</a>

...
class ProductController
{
    ...
    public function postFormSearchProduct()
    {
        ...
        $productList = $product->getProductListSearchedByName();
        require_once "views/admin/menuAdmin.php";
    }

    public function postFormSearchProductJson()
    {
        $product = new Product();
        $product->setNombre($_GET['search']);
        $productList = $product->getProductListSearchedByNameJson();
    ...
    public function moreInfo()
    {
        ...
        $aux->setId($_GET['id']);
        $product = $aux->getProductById();
        require_once "views/general/moreInfo.php";
    }
}
